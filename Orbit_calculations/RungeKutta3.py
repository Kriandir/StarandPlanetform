...
#     vy2 = []
    ...
    print "kx1= %.e, kx2 = %.e , kx3 = %.e kx4 = %e." %(ky1p,ky2p,ky3p,ky4p)
    print "kx1= %.e, kx2 = %.e , kx3 = %.e kx4 = %e." %(ky1s,ky2s,ky3s,ky4s)
    print '###################################'
...
def calcaccx(planet,xp,yp,xs,ys):
    ...
    if planet == False:
        ...
        # print 'this is R= %0.e'  %R
        print 'this is F= %0.e'  %Fs
        print 'this is ax= %0.e'  %axs
        return axs,ays
